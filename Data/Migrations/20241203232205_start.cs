    ...
    public partial class start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorQuizzes", x => new { x.InstructorId, x.QuizId });
                    table.ForeignKey(
                        name: "FK_InstructorQuizzes_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "InstructorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseWishlists", x => new { x.CourseId, x.WishlistId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseWishlists_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonQuizzes", x => new { x.LessonId, x.QuizId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "QuizId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonVideos", x => new { x.LessonId, x.VideoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_courseFeedbacks", x => new { x.CourseId, x.FeedbackId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_courseFeedbacks_Feedbacks_FeedbackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_courseFeedbacks_FeedbackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseWishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorQuizzes_QuizId",
                table: "InstructorQuizzes",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonQuizzes_QuizId",
                table: "LessonQuizzes",
                column: "QuizId");
